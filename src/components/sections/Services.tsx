    ...
    <section className="px-6 md:px-10">
      <div className="max-w-7xl mx-auto">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="sangBlue-font text-[48px] leading-tight text-center mt-6 md:mt-20"
        >
        ...
        <motion.div
          ...
          className="my-14 md:my-18 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5"
        >
          {solutions.map((item, idx) => {
            const isHovered = hoveredIndex === idx;

            return (
              <motion.div key={idx} variants={slideInBottom} className="w-full">
                <div
