        ...
        <CardContent className="p-8">
                      ...
                      <RadioGroup value={field.value} onValueChange={field.onChange}>
                        {[
                          ...
                          },
                          {
                            ...
                            description: "Complete new system installation required"
                          },
                          {
                            value: "partial",
                            label: "Some existing, needs upgrade",
                            description: "Partial upgrade and integration needed"
                          },
                        ].map((option) => (
          ...
          {currentStep === 4 && (
            <>
              <CardHeader className="px-0 pt-0">
                <CardTitle>Contact Information</CardTitle>
                <CardDescription>How can we reach you with your personalized quote?</CardDescription>
              </CardHeader>
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg text-sm text-gray-600">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>You'll receive a detailed quote via email within minutes</li>
