...
const WebSolution: React.FC = () => {
    return (
        <section>
            {/* Hero Section */}
            <div className="web-bg relative w-full h-[80vh] md:h-[75vh] lg:h-[72vh] overflow-hidden flex items-center justify-center text-center">
                <Motion
                    as="h1"
                    variants={slideInLeft}
                    className="sangBlue-font text-white text-[50px] md:text-[60px] lg:text-[65px] leading-tight"
                >
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-8">
                <div className="w-full flex flex-col md:flex-row-reverse items-center gap-10 mt-16 md:mt-28">
                    ...
                    >
                        <p>
                            At Blinkav, we craft modern web solutions that empower businesses to
                            thrive in the digital space. Our development process is rooted in
                            performance, user experience, and cutting-edge technologies that
                            ensure robust, scalable, and beautiful digital products.
                        </p>
                        <p>
                ...
                <div className="relative my-16 md:my-28">
                    <div className="flex flex-col md:flex-row items-center gap-10">
                        <Motion
                            ...
                            className="md:w-[46%] space-y-6 text-[17px] leading-loose"
                        >
                            <h2 className="text-2xl font-bold text-blue-900">Frontend Development</h2>
                            <p>
                                We build responsive, fast, and accessible interfaces using
                                technologies like React, Next.js, Vue.js, and TailwindCSS.
                                Every element is crafted to ensure an engaging user experience
                        ...
                        <Motion
                            as="div"
                            variants={slideInBottom}
                            className="w-full md:w-[45%] h-full rounded-xl overflow-hidden"
                        >
                            <Image
                                src="/images/frontend-dev.jpg"
                ...
                <div className="flex flex-col md:flex-row-reverse items-center gap-10 mb-20">
                    <Motion
                        ...
                        className="md:w-[46%] space-y-6 text-[17px] leading-loose"
                    >
                        <h2 className="text-2xl font-bold text-blue-900">Backend Development</h2>
                        <p>
                            We build secure, scalable, and high-performance backends using
                            Node.js, Express, NestJS, and PostgreSQL. Our APIs are designed to
                            support complex systems with ease, including real-time
                            functionality and secure data handling.
                        </p>
                        <p>
                            From database architecture to authentication and cloud integration,
                            we manage the heavy lifting so your product stays efficient and
                            maintainable.
                        </p>
                    </Motion>
                    <Motion
                ...
                <div className="flex flex-col md:flex-row items-center gap-10 mb-20">
                    <Motion
                        ...
                        className="md:w-[46%] space-y-6 text-[17px] leading-loose"
                    >
                        <h2 className="text-2xl font-bold text-blue-900">UI/UX Design</h2>
                        <p>
                            Design is at the heart of everything we build. Our designers use
                            tools like Figma, Adobe XD, and Sketch to create visually
                            compelling and highly functional interfaces that delight users and
                            drive engagement.
                        </p>
                        <p>
                ...
                <div className="flex flex-col md:flex-row-reverse items-center gap-10 mb-28">
                    <Motion
                        ...
                        className="md:w-[46%] space-y-6 text-[17px] leading-loose"
                    >
                        <h2 className="text-2xl font-bold text-blue-900">Mobile App Development</h2>
                        <p>
