...
const WorkspaceSolution: React.FC = () => {
  return (
    <section>
      <div className="workspace-bg relative w-full h-[80vh] md:h-[70vh] lg:h-[60vh] overflow-hidden flex items-center justify-center text-center">
        <motion.h1
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="w-full flex flex-col md:flex-row items-center gap-10 py-20">
          ...
          <div className="md:w-[46%] space-y-6">
            <div>
              <h2 className="text-xl md:text-[40px] leading-tight mb-4">
                Digital Signage
              </h2>

              <p className="neue-font text-[17px] leading-loose">
